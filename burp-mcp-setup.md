...
I connected Burp Suite Community 2026.7.3 to Codex with PortSwigger's MCP Server 1.3.0. I used the MCP server's packaged standard-input/output proxy instead of putting another web server between the two applications.
...
- The connection used Burp's current packaged proxy rather than the older third-party setup I had first found.
